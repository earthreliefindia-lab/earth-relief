...
export class Backend implements backendInterface {
    ...
    async getAllContactEntries(): Promise<Array<ContactEntry>> {
    ...
    async getAllPartnerEntries(): Promise<Array<PartnerEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPartnerEntries();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPartnerForm(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPartnerForm(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
